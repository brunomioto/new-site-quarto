...
open-graph:
  description: "Uma análise utilizando dandos do SUS"
  image: cover.png
twitter-card:
  description: "Uma análise utilizando dandos do SUS"
  image: cover.png
...
E quais as explicações científicas de pessoas do sexo masculino terem mais apendicite? Isso vamos deixar para um outro post...
