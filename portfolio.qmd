...
During all these years adventuring with **data**, **science** and **design**, I've been able to turn my **ideas** into **reality**. Currently I work as a **Data Analyst** at Vitru Education!
...
<div class="cards-wrapper">
    <a href="https://pedreirajr.github.io/cnefetools/" class="card-container" target="_blank" rel="noopener noreferrer">
        <div class="top-bar" style="background-color: #19446d; color: white;">cnefetools</div>
        <div class="hex-logo">
            <img src="./figures/hex-cnefetools.svg" alt="Logo do Pacote">
        </div>
        <div class="content-section">
            <p class="package-description">Download, cache and read municipality-level address data from the Cadastro Nacional de Enderecos para Fins Estatisticos (CNEFE) of the 2022 Brazilian Census, published by IBGE.</p>
        </div>
    </a>
...
<img src="/figures/microsoft-certified-associate-badge.svg" align="right" height="160"/>

I'm a **Power BI Data Analyst Associate (PL-300)** certified by [**Microsoft**](https://learn.microsoft.com/api/credentials/share/pt-br/BrunoMioto/A8DAC6423178868?sharingId=5EA64815F4FDBC0). I use Power BI daily at work to create dashboards for the logistics sector and understand KPIs for transportation, production, and much more!

Here's a dashboard I made for the [Power BI 10 Year Anniversary Contest](https://community.fabric.microsoft.com/t5/Contests-Gallery/Years-of-Change/td-p/4766098)!

![](figures/powerbi_10YearContest.webp){.lightbox group="my-gallery"}

You can use the interactive version below

```{=html}
<iframe title="PBI10_BrunoMioto" width="800" height="486" src="https://app.powerbi.com/view?r=eyJrIjoiMzJlMWRjODktZWQ1Ny00YmM1LThhMzYtM2JhZTNjZmI2NWQ4IiwidCI6ImIwZTczMzVmLWZkMWYtNDZhZC05OGM3LTU1ZTZlNGUyMjJlYSJ9&pageName=fd54c5179e41ba7a4b41" frameborder="0" allowFullScreen="true"></iframe>
```


<!-- I also made a dashboard for the 2020 Municipal Elections in my city using **Power BI**. (Unfortunately I no longer have the license and only have screenshots) -->
