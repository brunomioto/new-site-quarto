...
![](figures/charts/charts-vaccines.png){.lightbox fig-align="center" width="350"}
...
![](figures/charts/charts-nexo.png){.lightbox fig-align="center" width="350"}

## Original charts

All the following charts were made entirely using ggplot2/R.<br>You can click on each plot to see each detail.
